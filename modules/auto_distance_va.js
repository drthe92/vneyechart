 ...
 * auto_distance_va.js
 * =====================================================
 * Auto Distance VA (Tumbling E) — Test tự động đo thị lực nhìn xa cơ bản.
 *
...
const MODULE_ID = 'far-vision-auto-distance-va';
...
const autoDistanceVaModule = {
  id: MODULE_ID,
  label: 'Auto Distance VA',
  customControls: true,
  steps: ['test'],
  ...
  _renderIntro() {
    ...
    board.innerHTML = `
      <div class="bcva-intro" style="display:flex; flex-direction:column; justify-content:center; align-items:center; text-align:center; height:100%; padding:32px; box-sizing:border-box;">
        <h1 style="margin:0 0 8px; font-size:1.6em; color:#111;">🔬 Auto Distance VA (Tumbling E)</h1>
        <p style="max-width:720px; margin:4px 0; color:#333; line-height:1.55;">
          Test tự động đo thị lực nhìn xa cơ bản.
        </p>
  ...
  _finishTest() {
    ...
    const payload = {
      test_type: 'Auto Distance VA',
      is_manual_entry: false,
      clinical_metrics: {
        'OD (Mắt phải)': formatDecimal(this._results.OD),
        'OS (Mắt trái)': formatDecimal(this._results.OS)
      }
    };
...
export default autoDistanceVaModule;
export { autoDistanceVaModule };